package lk.nibm.weatherforecsatapp.adapter
...
import lk.nibm.weatherforecsatapp.R
...
class ForeCastAdapter : RecyclerView.Adapter<ForeCastHolder>() {
    ...
    override fun onBindViewHolder(holder: ForeCastHolder, position: Int) {
        ...
        holder.dateDayName.text = dateanddayname.toString()
        }
        catch (e:Exception){
            Log.e("Error","ForecastAdapter")
        }
